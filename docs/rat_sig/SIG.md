...
See the full document at the path above for:
- Architecture overview and diagram
- Design principles
- Full directory layout
- SDK integration code (`client.ts`, `agentMode.ts`, `streamParser.ts`)
- Swarm panel, Sandpack, template, and deployment details
- Sequence diagrams (generation, rewind, export)
